    ...
    <body>
        <div class="login">
            ...
            <form action="" method="POST" class="text-center">
                Usuario: <br>
                <input type="text" name="username" placeholder="Escribe el Usuario" required><br><br>

                Contraseña: <br>
                <input type="password" name="password" placeholder="Escribe la Contraseña" required>  <br><br>    

                <input type="submit" name="submit" value="Login" class="btn-primary">
                <br><br>
            </form>

            <p class="text-center">¿No estás registrado?, <a href="add-user.php" > hazlo aquí </a> </p>
...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($count==1)
        {
            ...
            $_SESSION['username'] = $username; //Verificamos si el usuario inició sesión o no y el cierre de sesión se desactivará.
